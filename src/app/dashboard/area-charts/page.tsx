...
export default function AreaCharts() {
  ...
  if (datasets.length === 0) {
    return (
      <div>
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Area Charts</h1>
          <p className="mt-2 text-gray-600">Visualize your data with area charts.</p>
        </div>
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">
                {!selectedXAxis || !selectedYAxis
                  ? 'Select X and Y axes to generate an area chart'
