...
export default function BubbleChart() {
  ...
  if (datasets.length === 0) {
    return (
      <div>
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Bubble Chart</h1>
          <p className="mt-2 text-gray-600">Visualize relationships between three numeric variables.</p>
        </div>
              ...
              <Bubble 
                ...
                options={{
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: `${selectedYAxis} vs ${selectedXAxis} (Size: ${selectedSize})`,
                    },
                    tooltip: {
                      callbacks: {
                        label: (context) => {
                          ...
                          return [
                            `${selectedXAxis}: ${point.x}`,
                            `${selectedYAxis}: ${point.y}`,
                            `${selectedSize}: ${point.r * 5}` // Reverse the scaling we applied
                          ];
                        }
                      }
                    }
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">
                {!selectedXAxis || !selectedYAxis || !selectedSize
                  ? 'Select X-axis, Y-axis, and Size to generate a bubble chart'
